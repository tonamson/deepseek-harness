...
The version and field set above are superseded in part by [pi-ai 0.86.1 upgrade compatibility](2026-09-21-pi-ai-0861-compatibility.md); this note's rationale for which fields are deployment controls still governs.
