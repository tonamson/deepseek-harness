...
authority: may create Peers for this task, settle the task, and run focused checks; may not invoke Codex or create a Lead

phase: task_implementation

task: task-a

mandatory Superpowers skills: subagent-driven-development, test-driven-development, verification-before-completion
