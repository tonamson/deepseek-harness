...
/**
 * Scheduler entry point omitted from the generated named service API. Loader
 * module instances share this key when the runtime and agent loop load separately.
 * @internal
 */
