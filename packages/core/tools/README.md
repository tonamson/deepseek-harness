...
The agent loop and tool registry use a shared global symbol to access the internal scheduler, including when the Loader imports separate instances of the tools module.
