...
| `ctx.orc` | `core` | [`experimental-orc`](../packages/experimental/orc) | - | [`experimental-tool-orc`](../packages/experimental/tool-orc) | - | Projects one Supervisor Session into role nodes, task phases, correlated delegations, and blocking review and audit findings; tool-orc exposes role-scoped operations. |
